...
const BSIT_PLAN = [
  {
    ...
    rows: [
      { grade: '', code: 'GE 4', units: 3.0, title: 'MATHEMATICS IN THE MODERN WORLD', desc: '', req: '' },
      { grade: '', code: 'GE 3', units: 3.0, title: 'THE CONTEMPORARY WORLD', desc: '', req: '' },
      {
        grade: '',
        code: 'GE 2',
        units: 6.0,
      ...
      { grade: '', code: 'GE 15', units: 3.0, title: 'ENVIRONMENTAL SCIENCE', desc: '', req: '' },
      { grade: '', code: 'CCE 101', units: 3.0, title: 'INTRODUCTION TO COMPUTING', desc: '', req: '' },
      { grade: '', code: 'CCE 102/L', units: 3.0, title: 'COMPUTER PROGRAMMING 1 (2ndT)', desc: '', req: '' },
      { grade: '', code: 'PAHF 1', units: 2.0, title: 'MOVEMENT COMPETENCY TRAINING', desc: '', req: '' },
      { grade: '', code: 'NSTP 1', units: 3.0, title: 'NATIONAL SERVICE TRAINING PROGRAM 1', desc: '', req: '' },
    ],
  },
  {
    term: '1st Year / 2nd Sem',
    rows: [
      { grade: '', code: 'GE 8', units: 3.0, title: 'READINGS IN PHILIPPINE HISTORY', desc: '', req: '' },
      {
        grade: '',
        code: 'UGE 1',
        units: 6.0,
      ...
      { grade: '', code: 'IT 1a', units: 3.0, title: 'IT ELECTIVE 1', desc: '', req: 'CCE 101/L' },
      { grade: '', code: 'CCE 103', units: 3.0, title: 'COMPUTER PROGRAMMING 2', desc: '', req: 'CCE 102/L' },
      { grade: '', code: 'IT 2', units: 3.0, title: 'DISCRETE MATHEMATICS', desc: '', req: '' },
      { grade: '', code: 'GE 1', units: 3.0, title: 'UNDERSTANDING THE SELF', desc: '', req: '' },
      { grade: '', code: 'PAHF 2', units: 2.0, title: 'EXERCISE-BASED FITNESS ACTIVITIES', desc: '', req: 'PAHF 1' },
      { grade: '', code: 'NSTP 2', units: 3.0, title: 'NATIONAL SERVICE TRAINING PROGRAM 2', desc: '', req: 'NSTP 1' },
    ],
  },
  {
    term: '2nd Year / 1st Sem',
    rows: [
      { grade: '', code: 'GE 7', units: 3.0, title: 'ART APPRECIATION', desc: '', req: '' },
      { grade: '', code: 'CCE 104/L', units: 3.0, title: 'INFORMATION MANAGEMENT', desc: '', req: 'CCE 101/L' },
      {
        grade: '',
        code: 'CCE 105',
        units: 3.0,
      ...
      { grade: '', code: 'IT 3/L', units: 3.0, title: 'NETWORKING 1', desc: '', req: 'IT 1a/L' },
      { grade: '', code: 'MTH 103', units: 3.0, title: 'PROBABILITIES AND STATISTICS', desc: '', req: 'IT 2' },
      { grade: '', code: 'IT 4', units: 3.0, title: 'CALCULUS 1', desc: '', req: 'IT 2' },
      { grade: '', code: 'IT 5', units: 3.0, title: 'IT ELECTIVE 2', desc: '', req: 'CCE 103/L' },
      { grade: '', code: 'PAHF 3', units: 2.0, title: 'DANCE AND SPORTS 1', desc: '', req: 'PAHF 2' },
    ],
  },
  {
    ...
    rows: [
      ...
      { grade: '', code: 'IT 8', units: 3.0, title: 'CALCULUS 2', desc: '', req: 'IT 4' },
      { grade: '', code: 'GE 6', units: 3.0, title: "RIZAL'S LIFE AND WORKS", desc: '', req: '' },
      {
        grade: '',
        code: 'IT 9a',
        units: 6.0,
      ...
      { grade: '', code: 'GE 5', units: 3.0, title: 'SCIENCE, TECHNOLOGY, AND SOCIETY', desc: '', req: '' },
      { grade: '', code: 'PAHF 4', units: 2.0, title: 'DANCE AND SPORTS 2', desc: '', req: 'PAHF 3' },
    ],
  },
  {
    term: '3rd Year / 1st Sem',
    rows: [
      { grade: '', code: 'IT 11', units: 3.0, title: 'NETWORKING 2', desc: '', req: 'IT 3/L, IT 9a/L' },
      {
        grade: '',
        code: 'IT 12/L',
        units: 3.0,
      ...
      { grade: '', code: 'IT 13', units: 3.0, title: 'PROFESSIONAL TRACK FOR IT 4', desc: '', req: 'IT 6/L' },
      { grade: '', code: 'PHYS 101', units: 4.0, title: 'COLLEGE PHYSICS 1', desc: '', req: 'IT 2' },
      { grade: '', code: 'GE 11', units: 3.0, title: 'THE ENTREPRENEURIAL MIND', desc: '', req: '' },
      {
        grade: '',
        code: 'IT 10/L',
        units: 3.0,
      ...
      { grade: '', code: 'IT 14', units: 3.0, title: 'PROFESSIONAL TRACK FOR IT 5', desc: '', req: 'IT 6/L' },
      {
        grade: '',
        code: 'CCE 106/L',
        units: 3.0,
